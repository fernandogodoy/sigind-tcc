...
/*
 * DetalhamentoCliente.java
 *
 * Created on 04/06/2011, 02:33:48
 */
 ...
 * @author Fernado
 */
public class DetalhamentoCliente extends javax.swing.JDialog {

    private Cliente cliente;

    /** Creates new form DetalhamentoCliente */
    public DetalhamentoCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);

    }

    public DetalhamentoCliente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Relatório Detalhamento do Cliente");
    ...
    private void btGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGerarActionPerformed
        try {
            ...
            List<Cliente> lista = daoR.consultaCliente(tfNome.getText());
            Map<String, String> parametros = new HashMap<String, String>();
            if (ckReunião.isSelected()) {
                relatorio = getClass().getResourceAsStream("/br/com/fernandogodoy/sigind/relatorios/RelatorioDetalhamentoCliente.jasper");
            } else {
                relatorio = getClass().getResourceAsStream("/br/com/fernandogodoy/sigind/relatorios/RelatorioDetalhamentoClienteImpressao.jasper");
            }
    ...
    private void btBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBuscarActionPerformed
        ...
        BuscaForm bc = new BuscaForm(TipoRelatorio.DETALHAMENTO_CLIENTE);
        if (bc.tabBusca.getSelectedRow() != -1) {
            cliente = (bc.getTmCliente().getLista().get(bc.tabBusca.getSelectedRow()));
            tfNome.setText(cliente.getRazaoCliente());
        }
