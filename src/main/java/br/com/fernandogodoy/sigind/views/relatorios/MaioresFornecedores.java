 ...
 * @author Fernado
 */
public class MaioresFornecedores extends javax.swing.JDialog {

    /** Creates new form OrdemProducaoPerido */
    public MaioresFornecedores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public MaioresFornecedores() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Relatório de Maiores Fornecedores");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Relatório de Maiores Fornecedores"));
    ...
    private void btGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGerarActionPerformed
        try {
            ...
            if (ckReunião.isSelected()) {
                relatorio = getClass().getResourceAsStream("/br/com/fernandogodoy/sigind/relatorios/MaioresFornecedores.jasper");
            } else {
                relatorio = getClass().getResourceAsStream("/br/com/fernandogodoy/sigind/relatorios/MaioresFornecedoresImpressao.jasper");
            }
