 ...
 * Cliente.java
 *
 * Created on 07/07/2010, 00:51:46
 */
...
public class ClienteForm extends MenuForm {
    ...
    public ClienteForm(Boolean consulta) {
        super(Login.usuario.getClienteUsuario());
        initComponents();
        setModal(true);
    ...
    private Cliente cliente() {
        if (!tfCodigoFornecedor.getText().isEmpty()) {
            getCliente().setDtCadCliente((Date) dfCadastro.getValue());
            getCliente().getPessoa().setIdPessoa(Long.parseLong(tfCodigoPessoa.getText()));
            getCliente().setIdCliente(Long.parseLong(tfCodigoFornecedor.getText()));
        } else {
            getCliente().setDtCadCliente(new Date());
        }
        getCliente().getPessoa().setBairroPessoa(tfBairro.getText().trim());
        getCliente().getPessoa().setCepPessoa(tfCep.getText().trim());
        getCliente().getPessoa().setComPessoa(tfComp.getText().trim());
        getCliente().getPessoa().setNomePessoa(tfNome.getText().trim());
        getCliente().getPessoa().setNumPessoa(tfNum.getText().trim());
        getCliente().getPessoa().setObsPessoa(tfObs.getText().trim());
        getCliente().getPessoa().setRuaPessoa(tfRua.getText().trim());
        getCliente().setRazaoCliente(tfRazao.getText().trim());
        getCliente().setContatoCliente(tfContato.getText().trim());
        getCliente().setCnpjCliente(tfCnpj.getText());
        getCliente().setAtivo(cbInativo.isSelected());
        return getCliente();
    }

    private void cliente(Cliente c) {
        tfCodigoFornecedor.setText(c.getIdCliente().toString());
        tfCodigoPessoa.setText(c.getPessoa().getIdPessoa().toString());
        tfNome.setText(c.getPessoa().getNomePessoa());
        tfContato.setText(c.getContatoCliente());
        dfCadastro.setValue(c.getDtCadCliente());
        cbInativo.setSelected(c.getAtivo());
        tfRua.setText(c.getPessoa().getRuaPessoa());
        tfNum.setText(c.getPessoa().getNumPessoa());
        tfBairro.setText(c.getPessoa().getBairroPessoa());
        tfCep.setText(c.getPessoa().getCepPessoa());
        tfComp.setText(c.getPessoa().getComPessoa());
        tfCodCidade.setText(c.getPessoa().getCidade().getIdMunicipio().toString());
        tfCidade.setText(c.getPessoa().getCidade().getxMun());
        tfUf.setText(c.getPessoa().getCidade().getUf().getSigla());
        tfObs.setText(c.getPessoa().getObsPessoa());
        tfCnpj.setText(c.getCnpjCliente());
        tfRazao.setText(c.getRazaoCliente());
        tabelaTelefone(c.getPessoa().getTelefones());
        tabelaEmail(c.getPessoa().getEmails());
    }
    ...
    private void limpaCamposConsulta() {
        ...
        table.setModel(new TableModelCliente(null));
    }
    ...
    public void tabelaCliente(List<Cliente> lista) {
        tmCliente = new TableModelCliente(lista);
        table.setModel(tmCliente);
    ...
    void buscaPessoa() {
        ...
        if (pf.table.getSelectedRow() != -1) {
            getCliente().setPessoa(pf.tmPessoa.getLista().get(pf.table.getSelectedRow()));
            tfCodigoPessoa.setText(getCliente().getPessoa().getIdPessoa().toString());
            tfNome.setText(getCliente().getPessoa().getNomePessoa());
            tfRua.setText(getCliente().getPessoa().getRuaPessoa());
            tfNum.setText(getCliente().getPessoa().getNumPessoa());
            tfBairro.setText(getCliente().getPessoa().getBairroPessoa());
            tfCep.setText(getCliente().getPessoa().getCepPessoa());
            tfComp.setText(getCliente().getPessoa().getComPessoa());
            tfCodCidade.setText(getCliente().getPessoa().getCidade().getIdMunicipio().toString());
            tfCidade.setText(getCliente().getPessoa().getCidade().getxMun());
            tfUf.setText(getCliente().getPessoa().getCidade().getUf().getSigla());
            tfObs.setText(getCliente().getPessoa().getObsPessoa());
            habilitaPessoa(false);
            btCancelaPessoa.setEnabled(true);
            tabelaTelefone(getCliente().getPessoa().getTelefones());
            tabelaEmail(getCliente().getPessoa().getEmails());
        }
    ...
    public void buscaCidade() {
        ...
        if (cf.table.getSelectedRow() != -1) {
            getCliente().getPessoa().setCidade(cf.tmCidade.getLista().get(cf.table.getSelectedRow()));
            tfCodCidade.setText(getCliente().getPessoa().getCidade().getIdMunicipio().toString());
            tfCidade.setText(getCliente().getPessoa().getCidade().getxMun());
            tfUf.setText(getCliente().getPessoa().getCidade().getUf().getSigla());
        }
    ...
    private Boolean verificaEmail() {
        for (Email email : getCliente().getPessoa().getEmails()) {
    ...
    private void addEmail() {
        if (!tfEmail.getText().isEmpty() || !tfEmail.getText().equals("")) {
            ...
            e.setPessoa(getCliente().getPessoa());
            if (getCliente().getPessoa().getEmails().size() != 0) {
                if (verificaEmail()) {
                    JOptionPane.showMessageDialog(null, "Esse e-mail já está incluso.");
                } else {
                    getCliente().getPessoa().getEmails().add(e);
                    tfEmail.setText("");
                }
            } else {
                getCliente().getPessoa().getEmails().add(e);
    ...
    private Boolean verificaTelefone() {
        for (Telefone fone : getCliente().getPessoa().getTelefones()) {
    ...
    private void addTelefone() {
        if (tfTelefone.getText().replace(" ", "").length() == 13) {
            ...
            t.setPessoa(getCliente().getPessoa());
            if (getCliente().getPessoa().getTelefones().size() != 0) {
                if (verificaTelefone()) {
                    JOptionPane.showMessageDialog(null, "Esse telefone já está incluso.");
                } else {
                    getCliente().getPessoa().getTelefones().add(t);
                    tfTelefone.setText("");
                    cbTipo.setSelectedIndex(0);
                }
            } else {
    ...
    private void mostraCidade() {
        try {
            ...
            c = cd.consultaCidade(Long.valueOf(tfCodCidade.getText().trim()));
            if (c != null) {
                getCliente().getPessoa().setCidade(c);
                tfCodCidade.setText(getCliente().getPessoa().getCidade().getIdMunicipio().toString());
                tfCidade.setText(getCliente().getPessoa().getCidade().getxMun());
                tfUf.setText(getCliente().getPessoa().getCidade().getUf().getSigla());
            } else {
                tfCodCidade.requestFocus();
                getCliente().getPessoa().setCidade(null);
                tfCodCidade.setText("");
                tfCidade.setText("");
                tfUf.setText("");
            }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Campos Marcados com (*) são de peenchimento obrigatório");
        ...
        tab.addTab("Dados do Cliente", tab01);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(51, 51, 51)
                .addComponent(tab, javax.swing.GroupLayout.DEFAULT_SIZE, 348, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void btCancelaPessoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCancelaPessoaActionPerformed
        ...
        habilitaPessoa(true);
        limpaCamposPessoa();
        getCliente().setPessoa(new Pessoa());
    ...
    public void salvar() {
        if (tfCidade.getText().trim().equals("") || cliente.getPessoa() == null || tfCnpj.getText().trim().equals("") || tfRazao.getText().trim().equals("")) {
            ...
            try {
                ...
                if (cause.contains("cliente_cnpjcliente_key")) {
                    JOptionPane.showMessageDialog(null, "CNPJ inválido, por favor digite outro");
                }
                if (cause.contains("cliente_idpessoa_key")) {
                    JOptionPane.showMessageDialog(null, "A Pessoa selecionada já é um Cliente,\npor favor selecione outra Pessoa.");
                }
                cd.cancel();
            }
        }
    ...
    public void excluir() {
        try {
            ...
            int sim = JOptionPane.showConfirmDialog(this, "Deseja realmente excluir esta Cliente?", "Atenção", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null);
            if (sim == JOptionPane.YES_OPTION) {
                cd.delete(getCliente());
                habExcluir();
                limpaCampos();
                limpaCamposPessoa();
            ...
            JOptionPane.showMessageDialog(null, "Esse cliente prima não pode ser excluido,\npossui relações.");
        }
    }
    ...
    public void listar() {
        ...
        tabelaCliente(cd.consulta(tfNomeConsultar.getText().trim(), ativo));
    }

    public void seleciona() {
        if (consulta) {
            if (table.getSelectedRow() != -1) {
                setCliente(tmCliente.getLista().get(table.getSelectedRow()));
                cliente(getCliente());
                tab(0, true, true, true, false);
            }
        } else {
