...
import br.com.fernandogodoy.sigind.dao.cadastros.PgContasPagarDao;
import br.com.fernandogodoy.sigind.dao.cadastros.PgContasPagarDaoImpl;
...
import br.com.fernandogodoy.sigind.models.tablemodel.TableModelConta;
import br.com.fernandogodoy.sigind.models.tablemodel.TableModelPgCompra;
 ...
 * @author Fernado
 */
public class PagamentoContaForm extends javax.swing.JDialog {

    private TableModelConta tmContas = new TableModelConta(null);
    private TableModelPgCompra tmPgCompra = new TableModelPgCompra(null);
    private ContasPagar contasPagar = new ContasPagar();

    /** Creates new form PagamentoContaForm */
    public PagamentoContaForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);

    }

    public PagamentoContaForm(Boolean consulta) {
        initComponents();
        setModal(true);
        setLocationRelativeTo(null);
        tableContasPagar.setModel(tmContas);
        tableContasPagar.updateUI();
        tablePagamento.setModel(tmPgCompra);
    ...
    private void initComponents() {
        ...
        tableContasPagar = new javax.swing.JTable();
        ...
        setTitle("Movimento de Pagamento de Contas");

        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder("Resultados"));

        tableContasPagar.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tableContasPagar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableContasPagarMouseClicked(evt);
            }
        });
        jScrollPane4.setViewportView(tableContasPagar);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jPanel8, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 624, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        tab.addTab("Lançamento de Pagamentos", jPanel2);
    ...
    private void btConsultarFiltros1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btConsultarFiltros1ActionPerformed
        ContasPagarDao dao = new ContasPagarDaoImpl();
        tmContas.setLista(dao.consultaContas());
        tableContasPagar.updateUI();


    }//GEN-LAST:event_btConsultarFiltros1ActionPerformed

    private void tableContasPagarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableContasPagarMouseClicked
        if (evt.getClickCount() >= 1) {
            contasPagar = (tmContas.getLista().get(tableContasPagar.getSelectedRow()));
            tmPgCompra.setLista(contasPagar.getPgConta());
            tablePagamento.updateUI();
            lbValorTotal.setText(new DecimalFormat("#,###0.00").format(contasPagar.getValorContasPagar()));
            consulta(true);
            calculaTotal();
        }
    }//GEN-LAST:event_tableContasPagarMouseClicked
    ...
    private javax.swing.JTable tableContasPagar;
    ...
    private void adicionaPagamento() {
        PgContasPagar pgContasPagar = new PgContasPagar();
        pgContasPagar.setContasPagar(contasPagar);
        pgContasPagar.setValorPgContasPagar(new BigDecimal(tfValor.getText().replace(".", "").replace(",", ".").trim()));
        pgContasPagar.setDtPgContasPagar((Date) dfDtPagamento.getValue());
        contasPagar.getPgConta().add(pgContasPagar);
        tmPgCompra.setLista(contasPagar.getPgConta());
        tablePagamento.updateUI();
        calculaTotal();
        limpar();
    ...
    public void calculaTotal() {
        BigDecimal total = contasPagar.getValorContasPagar();
        BigDecimal restante = BigDecimal.ZERO;
        BigDecimal somaPagamento = BigDecimal.ZERO;
        for (PgContasPagar pagamentos : contasPagar.getPgConta()) {
            somaPagamento = somaPagamento.add(pagamentos.getValorPgContasPagar());
        }
    ...
    private void removePagamento() {
        if (tablePagamento.getSelectedRow() != -1) {
            contasPagar.getPgConta().remove(tablePagamento.getSelectedRow());
            tmPgCompra.setLista(contasPagar.getPgConta());
            tablePagamento.updateUI();
            limpar();
            calculaTotal();
