 ...
 * @author Fernado
 */
public class PecaMaisVendidaGrafico extends javax.swing.JDialog {

    /** Creates new form OrdemProducaoPerido */
    public PecaMaisVendidaGrafico(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public PecaMaisVendidaGrafico() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Relatório de  Peças Vendidas");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Relatório de Peças Mais Vendidas"));
    ...
    private void btGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGerarActionPerformed
        try {
            ...
            if (ckReunião.isSelected()) {
                relatorio = getClass().getResourceAsStream("/br/com/fernandogodoy/sigind/relatorios/PecaMaisVendidaGrafico.jasper");
            } else {
                relatorio = getClass().getResourceAsStream("/br/com/fernandogodoy/sigind/relatorios/PecaMaisVendidaGraficoImpressao.jasper");
            }
