 ...
 * @author Fernado
 */
public class RelContasPagarForm extends javax.swing.JDialog {

    /** Creates new form RelCompraForm */
    public RelContasPagarForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);

    }

    public RelContasPagarForm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Relatório de Contas a Pagar"));
    ...
    private void btGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGerarActionPerformed
        try {
            ContasPagarDao daoR = new ContasPagarDaoImpl();
            InputStream relatorio;
            List<ContasPagar> lista = daoR.consultaContasPagar((Date) dfDtInicial.getValue(), (Date) dfDtFinal.getValue());
            Map<String, String> parametros = new HashMap<String, String>();
            if (ckReunião.isSelected()) {
                relatorio = getClass().getResourceAsStream("/br/com/fernandogodoy/sigind/relatorios/ContaPagar.jasper");
            } else {
                relatorio = getClass().getResourceAsStream("/br/com/fernandogodoy/sigind/relatorios/ContaPagarImpressao.jasper");
            }
