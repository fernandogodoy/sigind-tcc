 ...
 * @author Fernado
 */
public class RelCompraForm extends javax.swing.JDialog {

    /** Creates new form RelCompraForm */
    public RelCompraForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);

    }

    public RelCompraForm() {
        initComponents();
    ...
    private void btGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGerarActionPerformed
        try {
            CompraDao daoR = new CompraDaoImpl();
            InputStream relatorio;
            List<MatPrimaCompra> lista = daoR.consultar((Date) dfDtInicial.getValue(), (Date) dfDtFinal.getValue());
            Map<String, String> parametros = new HashMap<String, String>();
            if (ckReunião.isSelected()) {
                relatorio = getClass().getResourceAsStream("/br/com/fernandogodoy/sigind/relatorios/Compra.jasper");
            } else {
                relatorio = getClass().getResourceAsStream("/br/com/fernandogodoy/sigind/relatorios/CompraImpressao.jasper");
            }
