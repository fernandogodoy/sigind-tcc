 ...
 * @author Fernado
 */
public class RelContasReceberForm extends javax.swing.JDialog {

    /** Creates new form RelCompraForm */
    public RelContasReceberForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);

    }

    public RelContasReceberForm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Relatório de Contas a Receber"));
    ...
    private void btGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGerarActionPerformed
        try {
            ContasReceberDao daoR = new ContasReceberDaoImpl();
            InputStream relatorio;
            List<ContasReceber> lista = daoR.consultaContasReceber((Date) dfDtInicial.getValue(), (Date) dfDtFinal.getValue());
            Map<String, String> parametros = new HashMap<String, String>();
            if (ckReunião.isSelected()) {
                relatorio = getClass().getResourceAsStream("/br/com/fernandogodoy/sigind/relatorios/ContasReceber.jasper");
            } else {
                relatorio = getClass().getResourceAsStream("/br/com/fernandogodoy/sigind/relatorios/ContasReceberImpressao.jasper");
            }
