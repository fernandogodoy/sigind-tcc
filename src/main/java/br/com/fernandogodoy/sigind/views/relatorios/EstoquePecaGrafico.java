 ...
 * @author Fernado
 */
public class EstoquePecaGrafico extends javax.swing.JDialog {

    /** Creates new form OrdemProducaoPerido */
    public EstoquePecaGrafico(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public EstoquePecaGrafico() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Relatório de Estoque de Peças");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Relatório de Estoque de Peças"));
    ...
    private void btGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGerarActionPerformed
        try {
            ...
            if (ckReunião.isSelected()) {
                relatorio = getClass().getResourceAsStream("/br/com/fernandogodoy/sigind/relatorios/EstoquePecaGrafico.jasper");
            } else {
                relatorio = getClass().getResourceAsStream("/br/com/fernandogodoy/sigind/relatorios/EstoquePecaGraficoImpressao.jasper");
            }
