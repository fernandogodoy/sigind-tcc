...
/*
 * DetalhamentoUsuario.java
 *
 * Created on 06/06/2011, 17:05:21
 */
 ...
 * @author Fernado
 */
public class DetalhamentoUsuario extends javax.swing.JDialog {

    private Usuario usuario;

    /** Creates new form DetalhamentoUsuario */
    public DetalhamentoUsuario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        setTitle("Relatório Detalhamento do Usuário");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Relatório de Usuário"));
    ...
    private void btBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBuscarActionPerformed
        ...
        if (bc.tabBusca.getSelectedRow() != -1) {
            usuario = (bc.getTmUsuario().getLista().get(bc.tabBusca.getSelectedRow()));
            tfNome.setText(usuario.getFuncionario().getPessoa().getNomePessoa());
        }
    ...
    private void btGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGerarActionPerformed
        try {
            ...
            List<Usuario> lista = daoR.consultaUsuario(tfNome.getText());
            Map<String, String> parametros = new HashMap<String, String>();
            if (ckReunião.isSelected()) {
                relatorio = getClass().getResourceAsStream("/br/com/fernandogodoy/sigind/relatorios/RelatorioDetalhamentoUsuario.jasper");
            } else {
                relatorio = getClass().getResourceAsStream("/br/com/fernandogodoy/sigind/relatorios/RelatorioDetalhamentoUsuarioImpressao.jasper");
            }
